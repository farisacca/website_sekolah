            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link {{ request()->is('profil') ? 'active' : '' }} " href="{{ route('admin.profil') }}" href="ticket-list.html"
                                aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                                    class="hide-menu">Profil Sekolah 
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link {{ request()->is('guru') ? 'active' : '' }} " href="{{ route('admin.guru') }}" href="app-chat.html"
                                aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
                                    class="hide-menu">Kelola Guru</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link {{ request()->is('siswa') ? 'active' : '' }} " href="{{ route('admin.siswa') }}" href="app-calendar.html"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                                    class="hide-menu">Kelola Siswa</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link {{ request()->is('ekstrakurikuler') ? 'active' : '' }} " href="{{ route('admin.ekstrakulikuler') }}" href="app-calendar.html"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                                    class="hide-menu">Ekstrakurikuler</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link {{ request()->is('berita') ? 'active' : '' }} " href="{{ route('admin.berita') }}" href="app-calendar.html"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
                                    class="hide-menu">Berita</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link {{ request()->is('galeri') ? 'active' : '' }} " href="{{ route('admin.galeri') }}" href="app-calendar.html"
                                aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i><span
